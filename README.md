...
- [Mechanical montage](#mechanical-montage)
  - [Testing the components for compatibility](#testing-the-components-for-compatibility)
  - [Installing the rear wheel hub motor](#installing-the-rear-wheel-hub-motor)
- [E-bike battery introduction](#e-bike-battery-introduction)
- [Building a nickel strip spot welder for 18650 Li-ion batteries](#building-a-nickel-strip-spot-welder-for-18650-li-ion-batteries)
- [Converting a 60V LED switch mode power supply to an 18650 cell charger](#converting-a-60v-led-switch-mode-power-supply-to-an-18650-cell-charger)
...
### Testing the components for compatibility
...
![Controller dimensions](img/mech/controller.dims.jpg)
![Hub electronics test](img/mech/hub.jpg)
![Hub electronics wires](img/mech/controller.setup.jpg)
...
![Hub dimensions](img/mech/hub.calc.jpg)
![Spoke weaving](img/mech/hub.spokes.jpg)
...
![Controller with spokes](img/mech/controller.spokes.jpg)
![Controller with switches](img/mech/controller.switches.jpg)
![Wiring finished](img/mech/wiring.finished.jpg)
...
![Old protoboard](img/spot/old.proto.jpg)
![Old PCB](img/spot/old.pcb.jpg)
![Old Arduino 4 FETs](img/spot/old.arduino.jpg)
...
![Programming ATtiny85](img/spot/prog.jpg)
![ATtiny Arduino IDE settings](img/spot/attiny.settings.jpg)
![Spot welder testing](img/spot/prog.test.jpg)
...
![Spot welder](img/spot/welder.jpg)
![Spot welder back](img/spot/welder.back.jpg)
![Spot welder diagram](img/spot/diagram.jpg)
...
![Battery pack](img/spot/pack.jpg)
![Battery pack side](img/spot/pack2.jpg)
![Battery pack with BMS](img/spot/pack.bms.jpg)
...
![E-Bay LED SMPS](img/psu/ebay.jpg)
![Smps screwed open](img/psu/top.jpg)
![Smps pcb back](img/psu/back.jpg)
...
![Explore for solution](img/psu/explore.jpg)
![Final hack connections](img/psu/hack.conn.jpg)
![Final hack diagram](img/psu/hack.diagram.jpg)
